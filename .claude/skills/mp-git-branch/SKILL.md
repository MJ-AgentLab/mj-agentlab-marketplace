...
Creates and manages Git branches for **mj-agentlab-marketplace** following the project's bare-repo + worktree-per-branch convention. **6 temporary branch types** (per root `CONTRIBUTING.md`):
