...
**Reference**: [[../../../docs/rule/[STANDARD]_AI_Engineering_Execution_HITL_Prompt|HITL Prompt]] §3.1 (HITL 必停规则) + §4.1 (Stage 0 Intake prompt) + `../../../CONTRIBUTING.md` (branch types).
...
Marketplace 6 branch types (per root `CONTRIBUTING.md`):
...
- [[../../../CONTRIBUTING|CONTRIBUTING]]（branch / commit）
