...
description: >
  ...
  Do not use for: 创建知识库 (use notebooklm-kit:build), 生成制品 (use notebooklm-kit:studio),
  问答 (use notebooklm-kit:query), 管理 (use notebooklm-kit:manage), 完整学习闭环 (use notebooklm-kit:learn).
---
...
**依赖者**：`/notebooklm-kit:build`、`/notebooklm-kit:studio`、`/notebooklm-kit:query`、`/notebooklm-kit:manage` 的 Phase 0 认证检查均引用此技能。
