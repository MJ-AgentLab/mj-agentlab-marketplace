---
name: init
description: Initialize a learning subsystem in this project — scaffolds learning/ folder with 8-stage pedagogical methodology and INDEX. Use when starting pedagogical documentation for rule-list-based knowledge in a fresh project. After init, use /learn-kit:generate-tier for AI-driven three-tier (foundation/structural/challenge) learning doc generation, or follow METHODOLOGY 8 stages to author manually.
