...
PR-scope quality gate — verifies that a PR satisfies all Framework v4 documentation requirements (§9.3). Distinct from `mj-doc-validate` which checks individual files; this skill checks the PR holistically.
