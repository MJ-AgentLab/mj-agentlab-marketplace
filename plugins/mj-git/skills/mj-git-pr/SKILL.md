---
name: pr
description: Use when creating a Pull Request, selecting a PR template, filling PR fields, choosing deploy strategy for test environment, bumping version numbers, or performing a release for MJ System.
---
