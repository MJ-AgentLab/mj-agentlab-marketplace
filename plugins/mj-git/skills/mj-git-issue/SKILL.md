...
name: issue
description: >-
  Use when creating a GitHub Issue, selecting an issue template, filling issue fields,
  or starting a new task/bug report in MJ System.
  Triggers on 创建issue, 新建issue, 提issue, 报bug, 新任务,
