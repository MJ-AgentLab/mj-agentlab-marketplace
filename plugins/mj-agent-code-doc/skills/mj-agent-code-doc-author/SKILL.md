...
| 4 | **body skeleton 起草**：从 [body-skeleton-{type}.md](./body-skeleton-guide.md) 选对应类型骨架 copy + 填内容 | body-skeleton-*.md |
